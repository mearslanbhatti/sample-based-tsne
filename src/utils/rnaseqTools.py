"""
Code for handling RNASeq data by Kobak and Berens
Link to the file: https://github.com/berenslab/rna-seq-tsne/blob/master/rnaseqTools.py
"""
...
def geneSelection(data, threshold=0, atleast=10, 
                  yoffset=.02, xoffset=5, decay=1.5, n=None, verbose=1):
